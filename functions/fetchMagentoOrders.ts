...
Deno.serve(async (req) => {
    try {
        ...
        const response = await fetch(`${store_url}/rest/V1/orders?searchCriteria[filter_groups][0][filters][0][field]=status&searchCriteria[filter_groups][0][filters][0][value]=ORDER RECEIEVED - AWAITING SHIPMENT&searchCriteria[filter_groups][0][filters][0][condition_type]=eq`, {
            headers: {
